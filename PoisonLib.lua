...
ButtonsTab.Size = UDim2.new(0.94, 0, 0, 362)  -- Largura ajustada para 0.94

-- Barra de Pesquisa
local SearchBox = Instance.new("TextBox")
SearchBox.Name = "SearchBox"
SearchBox.Parent = ButtonsTab
SearchBox.Size = UDim2.new(0.94, 0, 0, 30)  -- Largura ajustada para 0.94
SearchBox.Position = UDim2.new(0.05, 0, 0, -25)  -- Ajustado para mover um pouco mais para baixo
SearchBox.BackgroundTransparency = 1  -- Remover fundo do TextBox
SearchBox.BackgroundColor3 = Color3.fromRGB(40, 40, 40)  -- Não é mais necessário, mas pode ser mantido para controle de cor de fundo
...
TabButtonText.TextColor3 = Color3.fromRGB(255, 255, 255) -- Cor do texto
