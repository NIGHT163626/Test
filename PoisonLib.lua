...
function library:CreateWindow(name, version, icon)
	...
	Icon.ImageColor3 = theme.UIStrokeColor
	...
	_4pxShadow2px_2.ImageColor3 = theme.BackgroundColor
	...
	function tabs:CreateTab(name)
		...
		Tabs.Name = "Tabs"
		Tabs.Parent = Window
		Tabs.BackgroundColor3 = theme.SidebarColor
		...
		SectionLabel.TextColor3 = theme.PrimaryTextColor
		...
		Indicator.BackgroundColor3 = theme.UIStrokeColor
		...
		function mytabbuttons:CreateFrame(name)
			...
			Page.ScrollBarImageColor3 = theme.ScrollBarColor
			...
			SearchBar.BackgroundColor3 = theme.PrimaryElementColor
			...
			SearchIcon.ImageColor3 = theme.UIStrokeColor

			Bar_3.Name = "Bar"
			Bar_3.Parent = SearchBar
			Bar_3.BackgroundColor3 = theme.UIStrokeColor
			...
			SearchBox.PlaceholderColor3 = theme.SecondaryTextColor
			...
			SectionContainer.BackgroundColor3 = theme.PrimaryElementColor
			...
			Header.BackgroundColor3 = theme.UIStrokeColor
			...
			PageButton.TextColor3 = theme.PrimaryTextColor
			PageButton.TextSize = 12.000
			...
			function pagebuttons:CreateButton(name, desc, callback)
				...
				Button.BackgroundColor3 = theme.SecondaryElementColor
				...
				spawn(function()
					local function QCZV_fake_script() -- Caller.Handler 
						...
						Sample.ImageColor3 = theme.UIStrokeColor
			...
			function pagebuttons:CreateLabel(name)
				...
				Label.BackgroundColor3 = theme.OtherElementColor
				...
				_4pxShadow2px.ImageColor3 = theme.UIStrokeColor
				...
				LabelContent.TextColor3 = theme.PrimaryTextColor
			...
			function pagebuttons:CreateSlider(name,min,max,callback)
				...
				Slider.BackgroundColor3 = theme.SecondaryElementColor
				...
				Title_4.Text = name
				Title_4.TextColor3 = theme.PrimaryTextColor
				Title_4.TextSize = 12.000
				Title_4.TextXAlignment = Enum.TextXAlignment.Left

				Tracker.Name = "Tracker"
				Tracker.Parent = Slider
				Tracker.BackgroundColor3 = theme.PrimaryElementColor
				...
				Indicator_3.BackgroundColor3 = theme.UIStrokeColor
				...
				Shadow_1.ImageColor3 = theme.UIStrokeColor
				...
				TextButton_2.BackgroundColor3 = theme.UIStrokeColor
				...
				Shadow_2.ImageColor3 = theme.UIStrokeColor
				...
				Fade.BackgroundColor3 = theme.UIStrokeColor
				...
				ValueText.Text = min
				ValueText.TextColor3 = theme.PrimaryTextColor
			...
			function pagebuttons:CreateColorPicker(name, callback)
				...
				ColorPicker.BackgroundColor3 = theme.SecondaryElementColor
				...
				ValueText2.TextColor3 = theme.PrimaryTextColor
			...
			function CreateNotification(Name, Description, Callback)
				...
				Notification2.BackgroundColor3 = theme.NotificationColor
				...
				_4pxShadow2px.Size = UDim2.new(1, 30, 1, 30)
				_4pxShadow2px.Image = "http://www.roblox.com/asset/?id=5761504593"
				_4pxShadow2px.ImageColor3 = theme.NotificationUIStrokeColor
				...
				TitleBar.BackgroundColor3 = theme.PrimaryElementColor
				...
				Corners.BackgroundColor3 = theme.PrimaryElementColor
				...
				TextLabel.TextColor3 = theme.SecondaryTextColor
				...
				Negative.BackgroundColor3 = theme.PrimaryElementColor
				...
				_4pxShadow2px_2.Size = UDim2.new(1, 30, 1, 30)
				_4pxShadow2px_2.Image = "http://www.roblox.com/asset/?id=5761504593"
				_4pxShadow2px_2.ImageColor3 = theme.NotificationUIStrokeColor
				_4pxShadow2px_2.ImageTransparency = 0.300
				_4pxShadow2px_2.ScaleType = Enum.ScaleType.Slice
				_4pxShadow2px_2.SliceCenter = Rect.new(17, 17, 283, 283)
				...
				Sample.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				Sample.BackgroundTransparency = 1.000
				Sample.Image = "http://www.roblox.com/asset/?id=45609099609"
				...
				Positive.BackgroundColor3 = theme.PrimaryElementColor
				...
				_4pxShadow2px_3.ImageColor3 = theme.NotificationUIStrokeColor
